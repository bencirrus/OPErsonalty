...
Four seeded buildings go in, ten specialist roles check rents, layouts, permits, repairs, financing, and downside, and the Downside Reviewer catches an unwarranted in-law unit - stripping its unsupported rent drops the Richmond triplex from 105% claimed coverage to 68% defensible, and a legal duplex takes the top spot.
