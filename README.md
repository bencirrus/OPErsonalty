...
Four seeded buildings go in, eight specialist roles check rents, layouts, permits, repairs, financing, and downside, and the Reviewer catches an unwarranted in-law unit - stripping its unsupported rent drops the Richmond triplex from 105% claimed coverage to 68% defensible, and a legal duplex takes the top spot.

## What's here

- `sf-ope-portal/` - the vertical slice: FastAPI app, intake schema, eight specialist roles, ranked pitches with evidence and risk tags, tests. See `sf-ope-portal/README.md` to run it.
